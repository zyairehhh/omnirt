...
- If the model has deployment quirks or known limitations, document them in the "Partial support" or "Awaiting hardware smoke" section of [docs/support-status.en.md](support-status.en.md).
